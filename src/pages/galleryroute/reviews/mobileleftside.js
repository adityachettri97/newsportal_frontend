...
const Mobileleftside = () => {
  return (
    <div>
        ...
        <div className="flex justify-between mt-10 border border-thingrey">
            <div className="flex items-start w-1/2">
            <Image className="m-5" src={Dpicture} alt="profile" />
            </div>
            <div className="flex flex-col gap-2 items-start mt-7 w-1/2">
