...
import Gadgets from "../../../components/assests/gadgets1.jpg"
  ...
  return (
    ...
    <div className="">
        ...
        <div className="flex items-center">
            ...
            <p><RiArrowDropRightLine className="text-lightgrey font-extralight mt-1"/></p>
            <Link className="text-xs text-lightgrey hover:text-black" href="/">Gadgets</Link>
            <p><RiArrowDropRightLine className="text-lightgrey font-extralight mt-1"/></p>
            <p className="text-lightgrey text-xs">Game Changing Virtual Reality Console Hits the Market</p>
        </div>
        <div className="">
        <button className="border bg-blue text-white hover:bg-brightblue duration-300 w-11 h-4 mt-2 text-xs">Gadgets</button>
        </div>
        <div>
            <h1 className="text-4xl mt-3">Game Changing Virtual Reality Console Hits the Market</h1>
        </div>
        <div>
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 mt-3">
                ...
                <p className="text-darkgrey text-xs p-1">21871</p>
                </div>
                <div className="flex items-center">
        ...
        <div>
            <Image className="mt-8" src={Gadgets} alt="gadgets"/>
            <p className="m-8">
        ...
        <div>
            ...
            <p className="text-3xl text-skyblue text-center italic mt-5">IF YOU HAVE IT, YOU CAN MAKE ANYTHING LOOK GOOD</p>
            </div>
            <div className="mt-8 w-10/12">
                <p>
        ...
        <div className="flex justify-between mt-10">
            <div className="flex flex-col items-start">
                ...
                <div className="hover:text-skyblue">
                    <p>Discover a Better Camera for Your YouTube Account</p>
                </div>
            </div>
            <div className="flex flex-col items-end">
                <p className="text-lightgrey  text-xs">Next article</p>
                <div className="hover:text-skyblue text-right">
                <p>Snapdragon Super Chip Mounted on the Latest Photo Cameras </p>
                </div>
            </div>
        </div>

        <div className="flex justify-between mt-10 gap-10 border border-thingrey">
