...
import NewsPortal from "../../../components/assests/newportal.jpg"
  ...
  return (
    <div>
            ...
            <div className="flex">
                ...
                <Link className="text-xs text-lightgrey hover:text-black" href="/">Fashion</Link>
                <p><RiArrowDropRightLine className="text-lightgrey font-extralight mt-1"/></p>
                <p className="text-lightgrey text-xs">WordPress News Magazine Charts the Most Chic and Fashionable Women of New...</p>
            </div>
            <div className="">
            <button className="border bg-red text-white hover:bg-brightred duration-300 w-10 h-4 mt-2 text-xs">Fashion</button>
            </div>
            <div>
                <h1 className="text-4xl mt-3">WordPress News Magazine Charts the Most Chic and Fashionable Women of New York City</h1>
            </div>
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 mt-8">
                    ...
                    <p className="text-darkgrey text-xs p-1">45176</p>
                    </div>
                    <div className="flex items-center">
            ...
            <div>
                <Image className="mt-8" src={NewsPortal} alt="news portal"/>
                <p className="m-8">
            ...
            <div className="flex justify-between gap-10 mt-10">
                <div className="flex flex-col">
                    ...
                    <div className="hover:text-skyblue">
                        <p>Now Is the Time to Think About Your Small-Business Success</p>
                    </div>
                </div>
                <div className="flex flex-col text-right">
                    <p className="text-lightgrey  text-xs">Next article</p>
                    <div className="hover:text-skyblue text-right">
                    <p>Expert Advice: The Best Retro Chic Fashion for All Ages </p>
                    </div>
                </div>
            </div>
